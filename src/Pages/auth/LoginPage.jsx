...
export default function LoginPage() {
    ...
    const submit = (e) => {
        e.preventDefault();
        const newErrors = {};
        if (!form.phone.trim()) newErrors.phone = 'Enter your phone or email';
        ...
        <MobileShell title="Login" showSearch={false}>
            ...
            <section className="min-h-[80vh] px-4 py-6">
                <div className="mb-8 text-center">
                    ...
                    <h1 className="mt-4 text-2xl font-black text-slate-950">Welcome!</h1>
                    <p className="mt-1 text-sm font-semibold text-slate-500">Login to your account</p>
                </div>
                ...
                <form onSubmit={submit} className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <button type="button" className="text-sm font-bold text-orange-600">
                            Forgot Password?
                        </button>
                    </div>
                ...
                <p className="mt-8 text-center text-sm font-semibold text-slate-500">
                    ...
                    <Link href={`/register${redirect !== '/' ? `?redirect=${encodeURIComponent(redirect)}` : ''}`} className="font-black text-orange-600">
                        Register
                    </Link>
                </p>
            </section>
