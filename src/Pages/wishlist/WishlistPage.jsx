...
export default function WishlistPage() {
    ...
    const handleShareWishlist = () => {
        ...
        const shareText = `Check out my wishlist on Progotix! ${items.length} items saved.`;
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            {items.length > 0 && (
                                <button
                                    ...
                                    className="grid h-12 w-12 place-items-center rounded-full bg-white/20 text-xl transition-all duration-200 hover:bg-white/30 active:scale-95"
                                >
                                    📤
                                </button>
                            )}
