...
export default function RegisterPage() {
    ...
    const submit = (e) => {
        ...
        if (!form.password) newErrors.password = 'Enter a password';
        if (form.password.length < 6) newErrors.password = 'Password must be at least 6 characters';
        if (form.password !== form.passwordConfirm) newErrors.passwordConfirm = 'Passwords do not match';
        if (!form.agreeTerms) newErrors.agreeTerms = 'Please accept the terms';
        ...
        <MobileShell title="Register" showSearch={false}>
            ...
            <section className="min-h-[80vh] px-4 py-6">
                <div className="mb-6 text-center">
                    ...
                    <h1 className="mt-4 text-2xl font-black text-slate-950">Create Account</h1>
                    <p className="mt-1 text-sm font-semibold text-slate-500">Start shopping on Progotix</p>
                </div>
                ...
                <form onSubmit={submit} className="space-y-4">
                    ...
                    <div>
                        <label className="mb-2 block text-xs font-bold text-slate-600">Confirm Password</label>
                        <div className="relative">
                            <span className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400">
                    ...
                    <label className="flex items-start gap-2 text-sm font-semibold text-slate-600">
                        ...
                        />
                        <span>
                            I agree to Progotix&apos;s{' '}
                            <button type="button" className="font-black text-orange-600">Terms & Conditions</button>{' '}
                            and{' '}
                            <button type="button" className="font-black text-orange-600">Privacy Policy</button>
                        </span>
                    </label>
